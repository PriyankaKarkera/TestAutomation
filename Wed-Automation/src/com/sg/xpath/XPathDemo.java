...
public class XPathDemo {
	...
	{
		oBrowser.findElement(By.xpath("//input[@value='Submitt' or @class='submit1btn1']")).click();
	}
	...
	static void relativeXPathUsingPartialMatchingOfAttributeValue()
	{
		...
		//oBrowser.findElement(By.xpath("//input[contains(@id,'mit')]")).click();
...
//Case 10(d)
 ...
 //Case 10(e)
	...
	{
		oBrowser.findElement(By.xpath("//a[text()='Maven Build Tool']")).click();
	}
