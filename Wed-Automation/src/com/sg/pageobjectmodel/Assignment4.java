...
public class Assignment4 {
	...
	static void modifycustomer()
	{
		try
		{
			oPage.getviewsettingbutton().click();
			Thread.sleep(1000);
			oPage.gotocustomernamelable().click();
			Thread.sleep(1000);
			oPage.gotocustomernameeditlable().sendKeys("Priyaaankaaa");
			Thread.sleep(1000);
			oPage.gotoActionbutton().click();
			Thread.sleep(2000);
	...
	static void deletecustomer()
	{
		try
		{
			...
			oPage.selectcustomerformodification().click();
			Thread.sleep(2000);
			
			oPage.gotoselectstarbutton().click();
			Thread.sleep(2000);
