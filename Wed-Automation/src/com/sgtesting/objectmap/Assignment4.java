...
public class Assignment4 {
	...
	static void modifycustomer()
	{
		try
		{
			...
			Thread.sleep(500);
			oBrowser.findElement(objectmap.getLocator("createdcustomernamelabelfield")).click();
			Thread.sleep(500);
			oBrowser.findElement(objectmap.getLocator("createdcustomernameeditfield")).sendKeys("Customer123");
			Thread.sleep(500);
			oBrowser.findElement(objectmap.getLocator("customerfieldactionbtn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("customermodifyfieldclosebtn")).click();
			Thread.sleep(1000);
