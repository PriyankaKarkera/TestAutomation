...
public class Assignment6 {
	...
	static void modifyproject()
	{
		try
		{
			...
			Thread.sleep(500);
			oBrowser.findElement(objectmap.getLocator("createdprojectnamelabelfield")).click();
			Thread.sleep(500);
			oBrowser.findElement(objectmap.getLocator("createdprojectnameeditfield")).sendKeys("field");
			Thread.sleep(500);
			oBrowser.findElement(objectmap.getLocator("projectfieldactionbtn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("projectmodifyfieldclosebtn")).click();
			Thread.sleep(1000);
