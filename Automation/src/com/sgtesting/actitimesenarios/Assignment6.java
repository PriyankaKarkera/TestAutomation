...
public class Assignment6 {
	...
	public  void modifyproject(String mpn)
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys(mpn);
			Thread.sleep(1000);
			...
			soft.assertAll();
			log.info("The Actitime modified project Successfully here...");
			}catch(Exception e)
		{
			e.printStackTrace();		
		}
